...
def folder2lmdb(json_data, img_dir, mask_dir, output_dir, split, write_frequency=1000):
    ...
    seen_classes_id = [0, 1, 2, 3, 6, 7, 8, 13, 14, 17,
                        18, 21, 22, 23, 24, 26, 28, 29, 30, 33,
                        37, 39, 42, 44, 45, 46, 47, 48, 49, 50,
                        51, 53, 54, 56, 59, 61, 62, 63, 64, 65,
                        68, 69, 70, 72, 73, 74, 75, 79]

    unseen_classes_id = [4, 5, 15, 16, 19, 20, 25, 27, 31, 36, 41, 43, 55, 57, 66, 71, 76]
    ...
    for idx, item in enumerate(tbar):
        ...
        data = {'img': img, 'mask': mask, 'cat': item['cat'],
                'seg_id': item['segment_id'], 'img_name': item['img_name'], 'img_id': item['img_id'],
