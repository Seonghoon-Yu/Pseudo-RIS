...
def build_batch_data_loader(
    ...
    *,
    ...
    """
    Build a batched dataloader. The main differences from `torch.my_utils.data.DataLoader` are:
    ...
    *,
    ...
    Args:
        ...
        collate_fn: a function that determines how to do batching, same as the argument of
            `torch.my_utils.data.DataLoader`. Defaults to do no collation and return a list of
...
def build_detection_test_loader(
    ...
    *,
    ...
    Args:
        ...
        collate_fn: same as the argument of `torch.my_utils.data.DataLoader`.
